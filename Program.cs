namespace Match_Details_Management_System
{
    internal class Program
    {
        static void Main()
        {
            ...
            matchManagement.AddMatch(new MatchDetails { MatchId = 2, Sport = "Cricket", MatchDateTime = DateTime.Parse("2023-09-07 14:00"), Location = "Stadium A", HomeTeam = "Team A", AwayTeam = "Team B", HomeTeamScore = 0, AwayTeamScore = 0 });
